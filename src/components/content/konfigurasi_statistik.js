        ...
        return (
            <div>
                        ...
                        <div className="kotakfilter2">
                            <form className="kotakforminputlogpintu" onSubmit={this.handleSubmitDaftar}>
                                ...
                                <div className="kotakinputjurusan">
                                    ...
                                    <input name="jumlahc" onChange={this.handleChange} className="inputformfakultas" type="number" placeholder="Jumlah dalam minggu..." required ></input>
                                </div>
                    ...
                    <div>
                        <div className="kotakfilter2">
                            <form className="kotakforminputlogpintu" onSubmit={this.handleSubmitEdit}>
                                ...
                                <div className="kotakinputjurusan">
                                    <label><b>Jumlah (minggu)</b> </label> <br></br>
                                    <input name="jumlahu_new" onChange={this.handleChange} className="inputformfakultas" type="number" placeholder="Jumlah dalam minggu..." value={state.jumlahu_new || ''} required ></input>
                                </div>
                ...
                <div id={aksidata} className="kotakdata">
                    <div>
                        <p>Berikut merupakan pengaturan yang digunakan pada Statistik Mahasiswa</p>
                    </div>
